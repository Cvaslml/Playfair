...
public class Playfair {
 public static void main(String[] args) {
  ...
  String cifrado = Cifrado_Playfair(mensaje,clave);
  String mensaje2 = Descifrado_Playfair(cifrado,clave);
  
  System.out.println("\nCifrado: "+ cifrado);
  System.out.println("Mensaje descifrado: "+mensaje2);
 }

 public static String Descifrado_Playfair(String cifrado,String clave){
